...
for line in days_count:
    ...
    if(splitted_line.__len__() == 2):   #c'è qualche valore mancante quindi serve questo
        if(int(splitted_line[1])>1000 and splitted_line[0]!='2017-04-18'): #per evitare il giorno "strano" con 220k tweet
